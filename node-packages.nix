...
let
  sources = {
    ...
    "electron-8.2.3" = {
      ...
      version = "8.2.3";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron/-/electron-8.2.3.tgz";
        sha512 = "FJUp103c8yJBoAaj/QM/OBde57iJh95u1yGJBytMUXmLFSsx78LmNE03QN4XCODyzi76IEcasvUcK6scogRLbQ==";
      };
    };
